        ...
        machine: (
          <Fragment>
            <button
              ...
              onClick={() =>
                navigate(`/create/store/physicalchemtest/${storeBranches._id}`)
              }>
              View Record
            </button>
          </Fragment>
          ...
          <Card className="bg-secondary shadow">
            <CardHeader className="bg-white border-0">
              <Row className="align-items-center">
                <Col xs="8">
                  <h3 className="mb-0">Physical and Chemical Testing Record</h3>
                </Col>
              </Row>
            </CardHeader>
...
export default PhysicalChemTest;
