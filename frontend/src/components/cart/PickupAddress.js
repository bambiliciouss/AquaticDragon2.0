...
const PickupAddress = () => {
  ...
  const savePickupAddressToSessionStorage = () => {
    const pickupAddress = {
      address,
      streetName,
      barangay,
    ...
    sessionStorage.setItem("pickupAddress", JSON.stringify(pickupAddress));
  };

  const processToNextStep = () => {
    savePickupAddressToSessionStorage();
